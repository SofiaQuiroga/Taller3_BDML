...
Sf_localidades$estrato <- ifelse(Sf_localidades$KENNEDY ==1 | Sf_localidades$ENGATIVA ==1 | Sf_localidades$PUENTE.ARANDA ==1 |Sf_localidades$ANTONIO.NARI�O ==1|Sf_localidades$LOS.MARTIRES ==1 
